...
const steps = [
  { num: '01', title: 'Deploy on your server', desc: 'Run one setup script. Add your Claude and Gemini API keys. Connect WhatsApp by scanning a QR code. Your data stays on your infrastructure.' },
  { num: '02', title: 'Describe what you need', desc: 'Open WhatsApp or the web dashboard. Type "Fix the login bug" or "Add Stripe checkout to the cart page." Oli Bot reads your codebase and gets to work.' },
          ...
          {steps.map((step, i) => (
            <FadeIn key={i} delay={i * 80}>
              <div className="flex gap-5 py-6">
                <div className="w-8 h-8 min-w-[32px] flex items-center justify-center bg-primary/10 text-primary font-mono text-[13px] font-medium rounded-md">
                  {step.num}
                </div>
                <div>
